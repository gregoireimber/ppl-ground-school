...
export const emergencyProceduresBasics: Lesson = {
  ...
  content: [
    ...
    },
    {
      ...
      ordered: false,
      items: [
        'A - Acknowledge failure by squawking 7600',
        'T - Transmit position and intentions blind on current frequency',
        'S - Set transponder to 7600',
        'O - Operate as per flight plan or last clearance',
        'C - Continue to maintain VMC if VFR',
        'A - Avoid controlled airspace if practical',
        'S - Select 121.5 MHz and continue blind transmission',
      ],
    },
    {
      type: 'callout',
      variant: 'tip',
      text: 'Memory aid for ATSOCAS: "All Transmitters Should Obviously Continue After Squawking"',
    },
    {
      type: 'heading',
      level: 2,
